...
def main():
    ...
    print("Step 6: Building baseline LSTM model...")
    model = build_baseline_lstm(window_size=20)
    ...
    print("Baseline LSTM Evaluation Results:")
    print("RMSE:", rmse)
    print("MAE:", mae)
    print("MAPE:", mape)
    ...
    print("\nBaseline LSTM Evaluation Results (First 200 Test Predictions):")
